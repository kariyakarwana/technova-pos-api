...
-- CreateIndex
CREATE INDEX "security_tokens_userId_purpose_idx" ON "security_tokens"("userId", "purpose");

-- CreateIndex
CREATE INDEX "security_tokens_purpose_expiresAt_idx" ON "security_tokens"("purpose", "expiresAt");

-- CreateIndex
CREATE INDEX "auth_attempts_action_identityHash_createdAt_idx" ON "auth_attempts"("action", "identityHash", "createdAt");

-- CreateIndex
CREATE INDEX "auth_attempts_action_ipHash_createdAt_idx" ON "auth_attempts"("action", "ipHash", "createdAt");
...
-- CreateIndex
CREATE INDEX "audit_events_outcome_createdAt_idx" ON "audit_events"("outcome", "createdAt");
